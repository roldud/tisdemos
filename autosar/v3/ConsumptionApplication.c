 ...
 *********************************************************************************************************************/
  ...
  if (RTE_E_OK==Rte_Read_TankPort_currentTankInML(&currentTank)) {
      if (RTE_E_OK==Rte_Read_TankPort_lastTankInML(&lastTank)) {
          if (RTE_E_OK==Rte_Read_TravelPort_estimatedKMRemaining(&remainingDistance)) {

              consumptionForOneKM = lastTank - currentTank;
              estimatedConsumption = consumptionForOneKM * remainingDistance;

              // only write estimatedConsumption when positive
